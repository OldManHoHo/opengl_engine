...
TGLHudElement::TGLHudElement(GLfloat in_width, GLfloat in_height, glm::vec2 in_pos, glm::vec3 in_color, char * texture_file, int top_left_tex_offset_x, int top_left_tex_offset_y, int bottom_right_tex_offset_x, int bottom_right_tex_offset_y) :
	params(4),
...
void TGLHudElement::set_offsets(glm::vec2 top_left, glm::vec2 bottom_right)
{
