...
tgl::HudElement::tgl::HudElement(GLfloat in_width, GLfloat in_height, glm::vec2 in_pos, glm::vec3 in_color, char * texture_file, int top_left_tex_offset_x, int top_left_tex_offset_y, int bottom_right_tex_offset_x, int bottom_right_tex_offset_y) :
	params(4),
	texture_active(false),
	top_left_tex_offset(top_left_tex_offset_x, top_left_tex_offset_y),
	bottom_right_tex_offset(bottom_right_tex_offset_x, bottom_right_tex_offset_y)
{
...
GLfloat * tgl::HudElement::get_params()
{
	params[0] = width;
	params[1] = height;
	params[2] = pos.x;
...
void tgl::HudElement::set_offsets(glm::vec2 top_left, glm::vec2 bottom_right)
{
