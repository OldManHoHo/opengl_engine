...
public:
	...
	HudElement(GLfloat in_width, GLfloat in_height, glm::vec2 in_pos, glm::vec3 in_color, char * texture_file = nullptr, int top_left_tex_offset_x = 0, int top_left_tex_offset_y = 0, int bottom_right_tex_offset_x = 0, int bottom_right_tex_offset_y = 0);
