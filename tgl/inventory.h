...
e_block_type item_id_to_block_type(ItemId item_id); //TODO: this stuff should not be in TGL
...
public:
	...
	InventoryItem(ItemId in_type = none, unsigned int in_quantity = 0);
...
public:
	...
	// Item Manipulation
	void set_item(unsigned int in_x, unsigned int in_y, ItemId in_type, unsigned int in_quantity);
