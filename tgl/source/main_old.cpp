...
int main()
{
	...
	gl_base.init();
	tgl::Texture cube_tex("content/textures/mc.png");
	std::vector<GLfloat> v(vertex_data, vertex_data + sizeof vertex_data / sizeof vertex_data[0]);
	//tgl::MeshVertices mesh_v(v);
	//tgl::Mesh tri_mesh(&mesh_v);
	//tgl::Material tri_mat;
