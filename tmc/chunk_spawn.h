...
public:
	...
	std::vector <tgl::Actor*> collect_nearby_dropped_items(glm::vec3 pos, double radius);
...
#ifdef _TGL_CLIENT
	std::vector <GLshort> tmc::ChunkSpawn::get_block_light_value(int in_x, int in_y, int in_z);
#endif
